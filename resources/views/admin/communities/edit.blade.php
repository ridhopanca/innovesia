...
<div class="p-8 max-w-7xl mx-auto">
    ...
    <div class="page-card rounded-2xl overflow-hidden p-8">
        <form id="communityForm" action="{{ route('admin.communities.update', $community->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            @if(request('referrer'))
            ...
            <!-- Slug (Hidden) -->
            <input type="hidden" name="slug" id="slug" value="{{ $community->slug }}">
