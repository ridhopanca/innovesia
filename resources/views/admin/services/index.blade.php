    ...
    <div class="mb-10">
        <div class="flex items-center gap-4 mb-3">
            ...
            <div>
                ...
                <p class="text-slate-500 mt-1">Manage your service pages</p>
            </div>
        </div>
        <div class="flex justify-end">
            <a href="{{ route('admin.services.create') }}" class="edit-btn inline-flex items-center gap-2 px-6 py-3 rounded-xl text-black font-semibold">
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <span class="text-sm text-slate-600">{{ $service->category ?? '-' }}</span>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <span class="text-sm text-slate-600">{{ $service->order }}</span>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex gap-2">
                            <a href="{{ route('admin.services.edit', $service->id) }}" class="text-indigo-600 hover:text-indigo-800 transition-colors">
